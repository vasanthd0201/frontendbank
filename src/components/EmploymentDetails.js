...
const EmploymentDetails = () => {
  ...
  const [retireDate, setRetireDate] = useState(null);
  ...
  const validateField = useCallback(
    (name, value) => {
      ...
      if (name === "otherOccDetails") {
        ...
        else if (value.length > 45) newErr[name] = "Max 45 characters";
      }
      ...
      if (name === "empId" && value.length > 16) newErr[name] = "Max 16 characters";
      ...
      if (name === "ppan" && value.length > 16) newErr[name] = "Max 16 characters";
  ...
  const validateAll = () => {
    ...
    if (
      form.relativePoliticalExposed &&
      !["Y", "N"].includes(form.relativePoliticalExposed)
    )
    ...
    if (form.ppan && form.ppan.length > 16) newErr.ppan = "Max 16 characters";
          ...
          <div className="form-grid">
            ...
            <label
              className={`form-field${
                errors.otherOccDetails ? " has-error" : ""
              }`}
            >
              <span className="form-label">
              ...
              />
              {errors.otherOccDetails && (
                <span className="error-text">{errors.otherOccDetails}</span>
              )}
            </label>
            ...
            <label className="form-field">
              ...
              <select
                ...
                onChange={(e) =>
                  handleChange("relativePoliticalExposed", e.target.value)
                }
              >
            ...
            <label
              className={`form-field${errors.dateOfJoining ? " has-error" : ""}`}
            >
              ...
              <DatePicker
                ...
                onChange={(date) => {
                  setJoinDate(date);
                  handleChange("dateOfJoining", formatToDDMMYYYY(date));
                }}
            ...
            {/* Date of Retirement — React DatePicker */}
            <label
              className={`form-field${
                errors.dateOfRetirement ? " has-error" : ""
              }`}
            >
              ...
              <DatePicker
                ...
                onChange={(date) => {
                  setRetireDate(date);
                  handleChange("dateOfRetirement", formatToDDMMYYYY(date));
                }}
                dateFormat="dd/MM/yyyy"
                placeholderText="dd/mm/yyyy"
                showMonthDropdown
              ...
              {errors.dateOfRetirement && (
                <span className="error-text">{errors.dateOfRetirement}</span>
              )}
            </label>

            {/* Income Range */}
            <label
              className={`form-field${errors.incomeRange ? " has-error" : ""}`}
            >
              ...
              />
              {errors.incomeRange && (
                <span className="error-text">{errors.incomeRange}</span>
              )}
            </label>
            ...
            <label
              className={`form-field${
                errors.politicallyExposed ? " has-error" : ""
              }`}
            >
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("politicallyExposed", e.target.value)
                }
              />
            </label>
            ...
            <label
              className={`form-field${
                errors.empDepartment ? " has-error" : ""
              }`}
            >
            ...
            {/* Ministry */}
            <label
              className={`form-field${errors.empMinistry ? " has-error" : ""}`}
            >
            ...
            {/* DDO Office */}
            <label
              className={`form-field${errors.ddoOffice ? " has-error" : ""}`}
            >
